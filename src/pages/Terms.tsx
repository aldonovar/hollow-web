    ...
    <div className="page-shell" ref={pageRef}>
      <section className="hero" style={{ minHeight: 'auto', paddingBottom: '3rem' }} data-page-hero>
        ...
        <p className="hero__subtitle">
          Última actualización: {new Date().toLocaleDateString('es-ES')}. Las reglas para mantener la comunidad DAW-fi segura y creativa.
        </p>
      </section>
        ...
        <div className="feature-grid" data-stagger style={{ gridTemplateColumns: '1fr', maxWidth: '800px', margin: '0 auto' }}>
          <article className="glass-card" data-stagger-item>
            ...
            <p className="glass-card__text" style={{ fontSize: '1.05rem', lineHeight: '1.7' }}>
              Al acceder y utilizar DAW-fi (incluyendo el Hub web y DAW-fi Studio), aceptas estar sujeto a estos Términos y Condiciones. Si no estás de acuerdo con alguna parte de los términos, no podrás acceder a nuestro servicio. Tu uso continuo de la plataforma constituye la aceptación incondicional de estos términos.
            </p>
          </article>
          ...
          <article className="glass-card" data-stagger-item>
            ...
            <p className="glass-card__text" style={{ fontSize: '1.05rem', lineHeight: '1.7' }}>
              Te comprometes a utilizar DAW-fi con fines legales e inspiradores. Queda estrictamente prohibido:
            </p>
          ...
          <article className="glass-card" data-stagger-item>
            ...
            <p className="glass-card__text" style={{ fontSize: '1.05rem', lineHeight: '1.7' }}>
              Aunque DAW-fi está diseñado con infraestructura de alta disponibilidad para maximizar tu tiempo de producción, el servicio se proporciona "tal cual". No garantizamos que el servicio será ininterrumpido o libre de errores en todo momento. Recomendamos mantener exportaciones locales `.esp` periódicas de tus proyectos críticos.
            </p>
          </article>
          ...
          <article className="glass-card" data-stagger-item>
            ...
            <p className="glass-card__text" style={{ fontSize: '1.05rem', lineHeight: '1.7' }}>
              DAW-fi evoluciona constantemente. Nos reservamos el derecho de modificar estos términos en cualquier momento. Notificaremos a los usuarios sobre cambios significativos a través del correo electrónico registrado o mediante un aviso destacado en el Hub.
            </p>
          </article>
        </div>
      </section>
