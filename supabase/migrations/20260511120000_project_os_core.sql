...
values
  ('project-audio', 'project-audio', false, 104857600, array['audio/wav', 'audio/x-wav', 'audio/flac', 'audio/mpeg']),
  ('project-stems', 'project-stems', false, 209715200, array['audio/wav', 'audio/x-wav', 'audio/flac', 'audio/mpeg']),
  ('project-exports', 'project-exports', false, 524288000, array['audio/wav', 'audio/x-wav', 'audio/aiff', 'audio/flac', 'audio/mpeg', 'application/zip']),
  ('asset-library', 'asset-library', false, 262144000, array['audio/wav', 'audio/x-wav', 'audio/flac', 'audio/mpeg', 'application/zip']),
